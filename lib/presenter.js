...
export const PERSONAS = {
  ...
  CONCIERGE: { name: "Aria", role: "Program assistant", hue: "#2f6d7d", voiceHint: "conversational" },
  BERNARD: { name: "Bernard", role: "Orchestrator", hue: "#2f4858", voiceHint: "measured" },
...
export function voiceFor(personaKey) {
  switch (personaKey) {
    ...
    case "CONCIERGE": return { rate: 1.04, pitch: 1.08 };
